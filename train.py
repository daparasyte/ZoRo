...
from rlgym.utils.reward_functions.common_rewards.player_ball_rewards import VelocityPlayerToBallReward, FaceBallReward, TouchBallReward
from rlgym.utils.reward_functions.common_rewards.ball_goal_rewards import VelocityBallToGoalReward, BallYCoordinateReward
    ...
    def get_match():  # Need to use a function so that each instance can call it and produce their own objects
        return Match(
            ...
            (
                ...
                FaceBallReward(),
                TouchBallReward(aerial_weight=0.6),
            ...
            terminal_conditions=[TimeoutCondition(round(fps * 300)), GoalScoredCondition()],
